...
export const SignInContainer = styled.div<SignInProps>`
  ...
  width: 50%;
  z-index: 2;
  ${({ signingIn }) => (signingIn !== true ? `transform: translateX(100%);` : null)}
`;
...
export const OverlayContainer = styled.div<SignInProps>`
  ...
  z-index: 100;
  ${({ signingIn }) =>
    signingIn !== true ? `transform: translateX(-100%);` : null}
`;

export const Overlay = styled.div<SignInProps>`
  background: #14213d;
  background: -webkit-linear-gradient(to right, #14213d, #14213d);
  ...
  transition: transform 0.6s ease-in-out;
  ${({ signingIn }) => (signingIn !== true ? `transform: translateX(50%);` : null)}
`;
...
export const LeftOverlayPanel = styled(OverlayPanel)<SignInProps>`
  ...
  ${({ signingIn }) => (signingIn !== true ? `transform: translateX(0);` : null)}
`;

export const RightOverlayPanel = styled(OverlayPanel)<SignInProps>`
  right: 0;
  transform: translateX(0);
  ${({ signingIn }) => (signingIn !== true ? `transform: translateX(20%);` : null)}
`;
